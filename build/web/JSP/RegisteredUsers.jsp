...
<body>
    <section id="header">
        ...
        <div class="header-right">
            ...
            <a href="../JSP/RegisteredUsers.jsp">Registered Users</a>
            <a href="#">Products</a>
            <a href="#">Orders</a>
                ...
                <c:forEach var="user" items="${users}">
                    <tr>
                        ...
                        <td class="action-btns">
                            <a href="<c:url value='/UserManagement?action=edit&id=${user.id}'/>" class="edit-btn">Edit</a>
    ...
    <script>
        ...
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this user?")) {
                window.location.href = "<c:url value='/UserManagement?action=delete&id='/>" + id;
            }
        }
